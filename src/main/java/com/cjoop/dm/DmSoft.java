...
public class DmSoft {
	 ...
	 * @throws Exception 
	 */
	public static void loadDmInfo() throws Exception{
		System.out.println("初始化大漠插件信息");
	 ...
	 */
	public static void regDmDll(File targetFolder){
	 ...
	 * 释放资源dm.dll到指定文件夹中.
	 */
	public static void extractResourceToFolder(ClassLoader classLoader,File targetFolder){
        targetFolder.mkdirs();
	 ...
	 */
	public static boolean checkDmDll(){
